 ...
 */
final class Version20230118165026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE strategy RENAME COLUMN user_id TO "user"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_7E1A4366A76ED395');
        $this->addSql('ALTER TABLE strategy RENAME COLUMN "user" TO user_id');
    }
}
